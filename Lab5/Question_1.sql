...
*/
v_titles := titlesList('advisor', 'director', 'assistant', 'manager', 'supervisor', 'chairman'); /* Added chairman */ 

v_salaries := salaryList(130000, 100000, 600000, 500000, 800000, 200000); /* Added 200000 */
